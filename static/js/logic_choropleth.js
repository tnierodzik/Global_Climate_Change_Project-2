...
d3.json(geoData, function(data) {
  ...
  geojson = L.choropleth(data, {
    ...
    // valueProperty: f`year_temp_${value_from_slider}`
    ...
    onEachFeature: function(feature, layer) {
      layer.bindPopup("Temperature: " + feature.properties.year_temp_2013 + "<br>Emissions:<br>" +
        "$" + feature.properties.year_emission_2013);
    }
  }).addTo(myMap);
